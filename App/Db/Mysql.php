...
class Mysql
{
    ...
    // Création d'un Singleton pour créer une instance unique 
    ...
    // Création d'un PDO qui sera unique
    public function getPDO()
    {
        if(is_null($this->pdo)) {
            $this->pdo = new \PDO(
                'mysql:dbname=' . $this->db_name . 
                ';charset=utf8;host=' . $this->db_host . 
                ';port=' . $this->db_port, $this->db_user, $this->db_password);
        }
        return $this->pdo;
    }
}